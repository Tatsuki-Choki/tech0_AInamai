...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('self_score', postgresql.JSONB(), nullable=True),
        sa.Column('ai_score', postgresql.JSONB(), nullable=True),
        sa.Column('ai_comment', sa.Text(), nullable=True),
        sa.Column('teacher_score', postgresql.JSONB(), nullable=True),
        sa.Column('teacher_comment', sa.Text(), nullable=True),
        sa.Column('final_score', postgresql.JSONB(), nullable=True),
