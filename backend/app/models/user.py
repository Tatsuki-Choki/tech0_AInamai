...
class Student(BaseModel):
    ...
    user_id = Column(UUID36, ForeignKey("users.id", ondelete="CASCADE"), nullable=False, unique=True)
    ...
    seminar_lab_id = Column(UUID36, ForeignKey("seminar_labs.id"), nullable=True)  # ゼミ・ラボ
    ...
    seminar_lab = relationship("SeminarLab", back_populates="students")
...
class Teacher(BaseModel):
    ...
    seminar_labs = relationship("SeminarLab", back_populates="teacher")
...
class StudentTeacher(BaseModel):
    ...
    teacher_id = Column(UUID36, ForeignKey("teachers.id", ondelete="CASCADE"), nullable=False)
